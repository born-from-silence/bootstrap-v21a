...
import { createPlugin } from "./tools/plugins/create";
...
async function main() {
  ...
  await tools.registerTool(createPlugin);
  ...
  let soul = "Identity file not found. Define your purpose.";
  try {
...
`;
  ...
  console.log(`=== Modular Substrate v21-exp1 Initialized [${gitCommit}] ===`);
